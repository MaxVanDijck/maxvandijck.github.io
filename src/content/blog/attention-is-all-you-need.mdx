...
- If two vectors are perpindicular their dot product will be 0 $n = 0$
...
As you can see if our query embedding is close within a vector space to the "fun" and "exciting" keys it results in a high attention to these values and opposite to the "boring" key resulting in a low attention score. In context of our pytorch code this is
